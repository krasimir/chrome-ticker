...
window.quotes =
	[
		...
		["Why do you need to write tests? Because you're not Chuck Norris. Chuck Norris' code tests itself, and it always passes, with 0ms execution time.", 'Andy Shora'],
		["There are 10 kinds of people in this world: those who understand binary and those who don't.", '...'],
		['Learn CSS, not the framework', 'Scott Kellum'],
		...
		['Why do we never have time to do it right, but always have time to do it over?', 'Eric Zhivalyuk'],
		['If you break the culture, you break the machine that creates your products.', 'Brian Chesky'],
		['I write to discover what I know', "O'Connor"],
		["I always seems impossible until it's done.", 'Nelson Mandela'],
		['The work you do while you are procrastinate is probably the work you should be doing for the rest of your life.', 'Jessica Hische'],
	];
})();
